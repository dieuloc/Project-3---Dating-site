<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="SignUp.aspx.cs" Inherits="TP_DatingSite.SignUp" %>
    ...
    <form id="form1" runat="server">
		...
		<div class="form-group">
			<div class="input-group">
                ...
                <asp:TextBox CssClass="form-control" ID="confirm_password" runat="server" placeholder="Confirm Password"></asp:TextBox>
			</div>
        </div>
        <div class="form-group">
